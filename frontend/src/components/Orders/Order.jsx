    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div id="infoCards" className="overflow-y-auto h-[calc(100vh)] w-5/6 bg-[#141415]">
                <CustomBtn />
                <Account />
                <h1 className="m-10 text-2xl font-medium font-poppins text-white flex items-center"> <FontAwesomeIcon icon={faArrowLeft} className="text-md pr-2" onClick={()=> navigate('/dashboard')} /> Orders</h1>
