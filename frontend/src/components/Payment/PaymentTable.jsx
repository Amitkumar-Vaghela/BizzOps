    ...
    return (
        <div className="flex justify-center items-center">
            <div className="w-full max-w-6xl bg-white shadow-md rounded-lg p-6">
                <h1 className="text-lg font-semibold mb-6 text-center">Payments</h1>
                        ...
                        {invoices.map((invoice) => (
                            <React.Fragment key={invoice._id}>
                                <tr className="odd:bg-white even:bg-gray-50 hover:bg-gray-50">
                                    ...
                                    <td className="border p-4 text-center">{invoice.paid ? <span className='text-green-600'>Yes</span> : 'No'}</td>
