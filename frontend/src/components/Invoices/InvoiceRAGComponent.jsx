...
const InvoiceRAGComponent = () => {
  ...
  const exampleQueries = [
    "Which customers have the highest unpaid amounts?",
    "What are my best-selling items?",
    "How much tax have I collected?",
    "Which customers buy the most frequently?",
    "What's my average invoice value?",
    "Show me payment trends and customer behavior",
    "Which items have the highest tax rates?",
    "Who are my most valuable customers by total revenue?"
  ];
        ...
        <div className="bg-[#36363a] text-white p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold">Invoice Data Assistant</h2>
                <p className="text-blue-100 text-sm">Ask questions about your invoices, customers, and payments</p>
              </div>
            </div>
            <button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ask anything about your invoice data..."
              ...
              {response.dataContext && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="font-bold text-lg">{response.dataContext.totalInvoices}</p>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Paid/Unpaid</p>
                    <p className="font-bold text-sm">{response.dataContext.paidInvoices}/{response.dataContext.unpaidInvoices}</p>
                  </div>
                  <div className="text-center">
                    <Users className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                    <p className="text-sm text-gray-600">Customers</p>
                    <p className="font-bold text-lg">{response.dataContext.uniqueCustomers}</p>
                  </div>
                </div>
              )}
...
export default InvoiceRAGComponent;